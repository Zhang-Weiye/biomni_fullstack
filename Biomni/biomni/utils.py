...
def save_plot_with_message(plt, filename, output_dir="./", prefix="plot"):
    """
    Save a matplotlib plot and output the picture showing message.
    ...
    prefix : str, optional
        Prefix for the filename, by default "plot"
    ...
    full_filename = f"{prefix}_{safe_filename}_{timestamp}.png"
    ...
    # Output picture showing message
    print(f"📷 picture showing: {full_path}")
