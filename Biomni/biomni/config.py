...
class BiomniConfig:
    ...
    path: str = "./data"
    saved_pictures_dir: str = "./saved_pictures"
    ...
    def __post_init__(self):
        ...
        if os.getenv("BIOMNI_SAVED_PICTURES_DIR"):
            self.saved_pictures_dir = os.getenv("BIOMNI_SAVED_PICTURES_DIR")
    ...
    def to_dict(self) -> dict:
        ...
        return {
            "path": self.path,
            "saved_pictures_dir": self.saved_pictures_dir,
